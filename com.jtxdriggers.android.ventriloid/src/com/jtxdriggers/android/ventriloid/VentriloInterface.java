...
public class VentriloInterface {
	...
	public static native void		channelban(short channelid, String reason);
	public static native int 		channelcount();
	public static native void		channelkick(short userid);
	public static native void		channelmute(short userid);
