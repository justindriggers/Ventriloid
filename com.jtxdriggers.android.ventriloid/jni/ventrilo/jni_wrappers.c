...
JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_pcmlengthforrate(JNIEnv* env, jobject obj, jint rate) {
	return v3_pcmlength_for_rate(rate);
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_joinchat() {
	v3_join_chat();
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_leavechat() {
	v3_leave_chat();
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_logout() {
	v3_logout();
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_phantomadd(JNIEnv* env, jobject obj, jchar channelid) {
	v3_phantom_add(channelid);
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_phantomremove(JNIEnv* env, jobject obj, jchar channelid) {
	v3_phantom_remove(channelid);
}

JNIEXPORT jboolean JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_isloggedin() {
	return v3_is_loggedin() != 0;
}

JNIEXPORT jchar JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_getuserid() {
	return v3_get_user_id();
}

JNIEXPORT jboolean JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_messagewaiting(JNIEnv* env, jobject obj, jboolean block) {
	return v3_message_waiting(block) != 0;
}

JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_getmaxclients() {
	return v3_get_max_clients();
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_clearevents() {
	v3_clear_events();
}

JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_getcodecrate(JNIEnv* env, jobject obj, jchar codec, jchar format) {
	return v3_get_codec_rate(codec, format);
}

JNIEXPORT jchar JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_getuserchannel(JNIEnv* env, jobject obj, jchar id) {
	return v3_get_user_channel(id);
}

JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_channelrequirespassword(JNIEnv* env, jobject obj, jchar channelid) {
	return v3_channel_requires_password(channelid);
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_startaudio(JNIEnv* env, jobject obj, jchar sendtype) {
...
JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_setuservolume(JNIEnv* env, jobject obj, jshort id, jint level) {
	v3_set_volume_user(id, level);
}

JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_setxmitvolume(JNIEnv* env, jobject obj, jint level) {
	v3_set_volume_xmit(level);
}

JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_usercount() {
	return v3_user_count();
}

JNIEXPORT jint JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_channelcount() {
	return v3_channel_count();
}

JNIEXPORT int JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_debuglevel(JNIEnv* env, jobject obj, jint level) {
	return v3_debuglevel(level);
}

JNIEXPORT int JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_getchannelrate(JNIEnv* env, jobject obj, jchar channelid) {
...
JNIEXPORT void  JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_forcechannelmove(JNIEnv* env, jobject obj, jshort userid, jshort channelid) {
	v3_force_channel_move(userid, channelid);
	return;
}

JNIEXPORT void  JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_sendpage(JNIEnv* env, jobject obj, jshort userid) {
...
JNIEXPORT void JNICALL Java_com_jtxdriggers_android_ventriloid_VentriloInterface_ban(JNIEnv* env, jobject obj, jshort userid, jstring reason) {
	char *_reason = get_string(env, reason);
